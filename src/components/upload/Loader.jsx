    ...
    <div className="loader">
      ...
      <svg id="pegtoptwo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100">
        <defs>
          ...
          <radialGradient id="gradient2-3" cx={85} cy={50} fx={85} fy={50} xlinkHref="#gradient2-2" />
          <radialGradient id="gradient2-4" cx={50} cy={58} fx={50} fy={58} r={60} gradientTransform="translate(0 47) scale(1 0.2)" xlinkHref="#gradient2-3" />
        ...
        <g>
          ...
          <path d="M63,37c-6.7-4-4-27-13-27s-6.3,23-13,27-27,4-27,13,20.3,9,27,13,4,27,13,27,6.3-23,13-27,27-4,27-13-20.3-9-27-13Z" fill="none" stroke="white" opacity="0.3" strokeWidth={3} filter="url(#shine2)" mask="url(#mask2)" />
      ...
      <svg id="pegtopthree" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100">
        <defs>
          ...
          <radialGradient id="gradient3-3" cx={85} cy={50} fx={85} fy={50} xlinkHref="#gradient3-2" />
          <radialGradient id="gradient3-4" cx={50} cy={58} fx={50} fy={58} r={60} gradientTransform="translate(0 47) scale(1 0.2)" xlinkHref="#gradient3-3" />
        ...
        <g>
          ...
          <path d="M63,37c-6.7-4-4-27-13-27s-6.3,23-13,27-27,4-27,13,20.3,9,27,13,4,27,13,27,6.3-23,13-27,27-4,27-13-20.3-9-27-13Z" fill="none" stroke="white" opacity="0.3" strokeWidth={3} filter="url(#shine3)" mask="url(#mask3)" />
