...
function buildItems(pool, seg) {
  // 🌐 CONFIGURATION GLOBE COMPLET
  const xCols = Array.from({ length: seg }, (_, i) => -37 + i * 2);
  
  // ⚙️ LIGNES VERTICALES - Augmenté pour une sphère complète (ajuste ici pour plus/moins de hauteur)
  const evenYs = [-8, -6, -4, -2, 0, 2, 4, 6, 8];  // 📊 9 lignes (plus = globe plus haut)
  const oddYs = [-7, -5, -3, -1, 1, 3, 5, 7, 9];   // 📊 9 lignes décalées
